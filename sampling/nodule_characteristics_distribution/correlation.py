...
annos_path='C:\\Users\\P70065719\\Desktop\\Thesis\\code_snippets\\mycode\\new_annotations_LUNA1.csv'
df=pd.read_csv(annos_path)
df.drop('seriesuid',axis=1,inplace=True)
corr=associations(df,theil_u=True,nominal_columns=['subtlety','margin','lobulation','spiculation','calcification_new','sphericity_new','texture_new','malignancy'])